...
Plugins.App.addListener(<span class="hljs-string">'appStateChanged'</span>, <span class="hljs-function">(<span class="hljs-params">err: <span class="hljs-built_in">any</span>, state: AppState</span>) =&gt;</span> {
...
Plugins.App.addListener(<span class="hljs-string">'pluginError'</span>, <span class="hljs-function">(<span class="hljs-params">err: <span class="hljs-built_in">any</span>, info: <span class="hljs-built_in">any</span></span>) =&gt;</span> {
  <span class="hljs-built_in">console</span>.error(<span class="hljs-string">'There was a serious error with a plugin'</span>, err, info);
});

<span class="hljs-keyword">var</span> ret = <span class="hljs-keyword">await</span> Plugins.App.canOpenUrl({ url: <span class="hljs-string">'com.getcapacitor.myapp'</span> });
<span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Can open url: '</span>, ret.value);

ret = <span class="hljs-keyword">await</span> Plugins.App.openUrl({ url: <span class="hljs-string">'com.getcapacitor.myapp://page?id=ionicframework'</span> });
<span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Open url response: '</span>, ret);

ret = <span class="hljs-keyword">await</span> Plugins.App.getLaunchUrl();
...
Plugins.App.addListener(<span class="hljs-string">'appUrlOpen'</span>, <span class="hljs-function">(<span class="hljs-params">err: <span class="hljs-built_in">any</span>, data: <span class="hljs-built_in">any</span></span>) =&gt;</span> {
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'App opened with URL: '</span> +  data.url);
});

Plugins.App.addListener(<span class="hljs-string">'appRestoredResult'</span>, <span class="hljs-function">(<span class="hljs-params">err: <span class="hljs-built_in">any</span>, data: <span class="hljs-built_in">any</span></span>) =&gt;</span> {
