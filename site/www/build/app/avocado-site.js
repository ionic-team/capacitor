...
var App = /** @class */ (function () {
    ...
    App.prototype.render = function () {
        return [
            h("div", { id: "main-div", class: this.isLandingPage ? "landing-page" : "" },
                h("site-header", null),
                h("div", { class: "app" },
            ...
            h("footer", { style: { display: this.isLandingPage ? 'none' : 'block' } },
...
var LandingPage = /** @class */ (function () {
    function LandingPage() {
        var root = document.querySelector('avocado-site');
        root.isLandingPage = true;
        document.title = "Avocado: Universal Web Applications";
    }
    LandingPage.prototype.componentDidUnload = function () {
        var root = document.querySelector('avocado-site');
                ...
                h("div", { class: "row" },
                    h("div", { class: "col" },
                        h("h1", { id: "action-call" },
                            "A universal runtime",
                            h("br", null),
                            " for containerizing web applications."),
                        h("div", { id: "action-more" },
                            "Build cross-platform apps with JS, HTML, and CSS",
                            h("br", null),
                            h("br", null),
                            h("b", null, "Sign up for updates and early access to the preview.")),
                        h("section", { id: "buttons" },
                            h("form", { id: "cta-form" },
                                h("div", { class: "input-with-button" },
                                    h("input", { type: "email", placeholder: "Email address" }),
                                    h("button", null, "Notify me"))))),
