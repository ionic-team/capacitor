    ...
    BlogPage.prototype.render = function () {
        return (h("div", { id: "blog", class: "wrapper" },
            h("div", { class: "post" },
                ...
                h("p", null, "Today the Ionic team is excited excited to announce a new Private Preview open source project called Avocado that makes it easier to build and deploy web apps on iOS, Android, Electron, and the web as a Progressive Web App, all while maximizing code reuse."),
                ...
                h("p", null,
                    "We are hopefuly that Avocado will enable teams with only web developers to build great apps, ",
                    h("i", null, "and"),
