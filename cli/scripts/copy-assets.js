...
const PLUGINS_FOLDER = 'capacitor-android-plugins';
const PLUGINS_FOLDER_SRC = path.join(MONOREPO_ROOT, PLUGINS_FOLDER);
const PLUGINS_FOLDER_DST = path.join(ASSETS_DIST, PLUGINS_FOLDER);
...
fs.copySync(PLUGINS_FOLDER_SRC, PLUGINS_FOLDER_DST);