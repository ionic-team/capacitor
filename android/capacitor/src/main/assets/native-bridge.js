  ...
  var initBridge = function (w) {
    ...
    var initEvents = function (win, cap) {
      ...
      cap.addListener = function (pluginName, eventName, callback) {
        var callbackId = cap.nativeCallback(
          pluginName,
          'addListener',
          {
            eventName: eventName,
    ...
    var initVendor = function (win, cap) {
      ...
      IonicWebView.getServerBasePath = function (callback) {
        ...
        (_a =
          ...
          null || _a === void 0
          ? void 0
          : _a.getServerBasePath().then(function (result) {
      ...
      IonicWebView.setServerBasePath = function (path) {
        ...
        (_a =
          ...
          null || _a === void 0
          ? void 0
          : _a.setServerBasePath({ path: path });
      };
    ...
    var initLogger = function (win, cap) {
      ...
      var createLogFromNative = function (c) {
      ...
      var createLogToNative = function (c) {
      ...
      if (win.console && isIos) {
        ...
        for (
          var _i = 0, BRIDGED_CONSOLE_METHODS_1 = BRIDGED_CONSOLE_METHODS;
          _i < BRIDGED_CONSOLE_METHODS_1.length;
          _i++
        ) {
        ...
        try {
          ...
          if (storedCall) {
            ...
            if (result.error) {
              ...
              result.error = Object.keys(result.error).reduce(function (
                err,
                key,
              ) {
