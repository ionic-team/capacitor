...
public class Dialogs {
    ...
    public static void confirm(final Context context, final String message, final Dialogs.OnResultListener listener) {
    ...
    public static void prompt(final Context context, final String message, final Dialogs.OnResultListener listener) {
    ...
    public static void actions(
        ...
        final Dialogs.OnCancelListener cancelListener
    ) {
