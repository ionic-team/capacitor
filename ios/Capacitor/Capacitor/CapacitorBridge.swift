...
open class CapacitorBridge: NSObject, CAPBridgeProtocol {
    ...
    // MARK: - Initialization
    @available(*, deprecated, message: "Use the init without cordovaConfiguration")
    public init(with configuration: InstanceConfiguration, delegate bridgeDelegate: CAPBridgeDelegate, cordovaConfiguration: Any? = nil, assetHandler: WebViewAssetHandler, delegationHandler: WebViewDelegationHandler, autoRegisterPlugins: Bool = true) {
