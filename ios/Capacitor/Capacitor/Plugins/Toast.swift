...
public class CAPToastPlugin : CAPPlugin {
  ...
  @objc func show(_ call: CAPPluginCall) {
    ...
    DispatchQueue.main.async {
      ...
      lb.frame = CGRect(x:((vc.view.bounds.size.width)/2) - ((expectedSizeTitle.width+16)/2) , y: (vc.view.bounds.size.height/2) - ((expectedSizeTitle.height+16)/2), width: expectedSizeTitle.width+16, height: expectedSizeTitle.height+16)
